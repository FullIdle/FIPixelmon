...
public class MarkCharmCommand extends PixelmonCommand {
   public MarkCharmCommand() {
      super("markcharm", "/markcharm [player]", 2);
   }
   ...
   public void execute(ICommandSender sender, String[] args) throws CommandException {
      if (args.length <= 2) {
         ...
         party.setMarkCharm(newState);
         if (sender != player) {
            this.sendMessage(sender, "pixelmon.command.markcharm.success", new Object[]{player.func_70005_c_()});
         }

         this.sendMessage(player, "pixelmon.command.markcharm.received", new Object[0]);
         func_152374_a(sender, this, 0, "pixelmon.command.markcharm.notify", new Object[]{sender.func_70005_c_(), player.func_70005_c_()});
      } else {
