...
public abstract class AbstractIntegerPokemonRequirement extends AbstractPokemonRequirement {
   protected int value;
   protected int defaultValue;

   public AbstractIntegerPokemonRequirement(Set keys, int defaultValue) {
      super(keys);
      this.defaultValue = defaultValue;
   }

   public AbstractIntegerPokemonRequirement(Set keys, int defaultValue, int value) {
