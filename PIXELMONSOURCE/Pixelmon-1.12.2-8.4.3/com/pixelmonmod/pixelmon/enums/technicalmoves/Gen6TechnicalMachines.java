...
public enum Gen6TechnicalMachines implements ITechnicalMove {
   ...
   Power_Up_Punch(98, "Power-Up Punch"),
   Dazzling_Gleam(99, "Dazzling Gleam"),
   Confide(100, "Confide"),
   Secret_Power(101, "Secret Power");

   private final int id;
   private final String attackName;
   private static final Gen6TechnicalMachines[] VALUES = values();
   ...
   private Gen6TechnicalMachines(int id, String attackName) {
      this.id = id;
   ...
   static {
      Gen6TechnicalMachines[] var0 = VALUES;
      int var1 = var0.length;

      for(int var2 = 0; var2 < var1; ++var2) {
         Gen6TechnicalMachines tm = var0[var2];
         idMap.put(tm.id, tm);
