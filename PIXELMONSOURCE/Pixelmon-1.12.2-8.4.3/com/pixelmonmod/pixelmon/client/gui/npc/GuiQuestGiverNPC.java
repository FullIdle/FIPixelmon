...
public class GuiQuestGiverNPC extends GuiScreen {
   public static ArrayList chatPages;
   public static String name;
   int currentPage = 0;
   int currentTrainerID;

   public GuiQuestGiverNPC(int trainerId) {
      Optional entityNPCOptional = EntityNPC.locateNPCClient(Minecraft.func_71410_x().field_71441_e, trainerId, NPCQuestGiver.class);
