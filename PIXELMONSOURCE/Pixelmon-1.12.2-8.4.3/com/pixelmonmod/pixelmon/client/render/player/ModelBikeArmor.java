...
public class ModelBikeArmor extends ModelBiped {
   public ModelBikeArmor() {
      this(0.0F);
   }
   ...
   protected ModelBikeArmor(float modelSize, int textureWidthIn, int textureHeightIn) {
   ...
   public void func_78087_a(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
      ...
      if (bike != null) {
         ...
         ModelPlayerOnBike.copyModelSettings(this.field_78116_c, this.field_178720_f);
      }
   }
}
