...
public class WaterstoneEffect implements IArmorEffect {
      ...
      if (!world.field_72995_K) {
         if (IArmorEffect.isWearingFullSet(player, armor.field_77878_bZ) && player.field_70173_aa % 20 == 1) {
            if (!stack.func_77948_v()) {
               stack.func_77966_a(Enchantments.field_185299_g, 2);
            }

            player.func_70690_d(new PotionEffect(MobEffects.field_76427_o, 40, 1, true, true));
         }
