...
public class CatchingCharmCommand extends PixelmonCommand {
   public CatchingCharmCommand() {
      super("catchingcharm", "/catchingcharm [player]", 2);
   }
   ...
   public void execute(ICommandSender sender, String[] args) throws CommandException {
      if (args.length <= 2) {
         ...
         party.setCatchingCharm(newState);
         if (sender != player) {
            this.sendMessage(sender, "pixelmon.command.catchingcharm.success", new Object[]{player.func_70005_c_()});
         }

         this.sendMessage(player, "pixelmon.command.catchingcharm.received", new Object[0]);
         func_152374_a(sender, this, 0, "pixelmon.command.catchingcharm.notify", new Object[]{sender.func_70005_c_(), player.func_70005_c_()});
      } else {
