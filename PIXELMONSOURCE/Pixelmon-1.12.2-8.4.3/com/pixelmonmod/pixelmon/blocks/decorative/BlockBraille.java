...
public class BlockBraille extends GenericBlock {
   ...
   public BlockBraille(boolean secondHalf) {
   ...
   public void func_149666_a(CreativeTabs itemIn, NonNullList list) {
   ...
   public static int getSpaceBrailleBlockIndex() {
