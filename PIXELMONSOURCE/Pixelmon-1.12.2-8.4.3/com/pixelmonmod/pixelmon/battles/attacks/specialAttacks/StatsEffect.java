...
public class StatsEffect extends EffectBase {
   ...
   public AttackResult applyStatEffect(PixelmonWrapper user, PixelmonWrapper target, AttackBase a) {
      ...
      if (affected.isFainted()) {
         return a != null && a.getAttackCategory() == AttackCategory.STATUS ? AttackResult.failed : AttackResult.succeeded;
      } else if (!this.checkChance()) {
         return AttackResult.succeeded;
      } else if (affected.getBattleStats().modifyStat(this.amount, this.type, user, true)) {
