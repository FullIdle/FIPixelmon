...
public class GuiChattingNPCEditor extends GuiScreenDropDown {
   ...
   public GuiChattingNPCEditor(int npcID) {
      ...
      Optional npcChattingOptional = EntityNPC.locateNPCClient(Minecraft.func_71410_x().field_71441_e, npcID, NPCChatting.class);
      if (!npcChattingOptional.isPresent()) {
         GuiHelper.closeScreen();
      } else {
         this.npc = (NPCChatting)npcChattingOptional.get();
         currentNPCID = npcID;
         if (this.npc == null) {
            GuiHelper.closeScreen();
         }
   ...
   public void func_73866_w_() {
      ...
      this.page1Box.func_146180_a(!chatPages.isEmpty() ? (String)chatPages.get(0) : "");
      ...
      this.page2Box.func_146180_a(chatPages.size() > 1 ? (String)chatPages.get(1) : "");
      ...
      this.page3Box.func_146180_a(chatPages.size() > 2 ? (String)chatPages.get(2) : "");
      ...
      this.page4Box.func_146180_a(chatPages.size() > 3 ? (String)chatPages.get(3) : "");
      chatChanged = false;
      this.oldName = name;
   }
