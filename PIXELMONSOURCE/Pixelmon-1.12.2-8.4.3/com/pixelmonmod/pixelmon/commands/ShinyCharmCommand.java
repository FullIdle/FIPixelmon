...
public class ShinyCharmCommand extends PixelmonCommand {
   public ShinyCharmCommand() {
      super("shinycharm", "/shinycharm [player]", 2);
   }
   ...
   public void execute(ICommandSender sender, String[] args) throws CommandException {
      if (args.length <= 2) {
         ...
         party.setShinyCharm(newState);
         if (sender != player) {
            this.sendMessage(sender, "pixelmon.command.shinycharm.success", new Object[]{player.func_70005_c_()});
         }

         this.sendMessage(player, "pixelmon.command.shinycharm.received", new Object[0]);
         func_152374_a(sender, this, 0, "pixelmon.command.shinycharm.notify", new Object[]{sender.func_70005_c_(), player.func_70005_c_()});
      } else {
