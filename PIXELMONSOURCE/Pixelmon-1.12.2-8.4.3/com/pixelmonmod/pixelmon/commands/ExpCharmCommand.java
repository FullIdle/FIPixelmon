...
public class ExpCharmCommand extends PixelmonCommand {
   public ExpCharmCommand() {
      super("expcharm", "/expcharm [player]", 2);
   }
   ...
   public void execute(ICommandSender sender, String[] args) throws CommandException {
      if (args.length <= 2) {
         ...
         if (sender != player) {
            this.sendMessage(sender, "pixelmon.command.expcharm.success", new Object[]{player.func_70005_c_()});
         }

         this.sendMessage(player, "pixelmon.command.expcharm.received", new Object[0]);
         func_152374_a(sender, this, 0, "pixelmon.command.expcharm.notify", new Object[]{sender.func_70005_c_(), player.func_70005_c_()});
      } else {
