...
public class TileEntityRug extends TileEntity implements ISpecialTexture {
   private static ResourceLocation[] textures = new ResourceLocation[ColorEnum.values().length];

   public ResourceLocation getTexture() {
      IBlockState state = this.func_145831_w().func_180495_p(this.func_174877_v());
      if (state.func_177230_c() instanceof BlockRug) {
         BlockRug block = (BlockRug)state.func_177230_c();
   ...
   static {
      ...
      for(int var2 = 0; var2 < var1; ++var2) {
         ...
         textures[color.ordinal()] = new ResourceLocation("pixelmon:textures/blocks/rug/" + color + "PokeballRugModel.png");
      }
